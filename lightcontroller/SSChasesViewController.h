...
@interface SSChasesViewController : UIViewController <UIPageViewControllerDelegate, UITableViewDelegate, UITableViewDataSource, NSFetchedResultsControllerDelegate, NSFetchedResultsSectionInfo>
{
